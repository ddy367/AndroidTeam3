...
public class L_UserListAdapter extends BaseAdapter {
    private Context context;
    private List<com.bitc.L_User> userList;
    private Activity parentActivity;//회원삭제 강의때 추가
    //여기서 Actvitivy parentActivity가 추가됨 회원삭제 및 관리자기능 예제
    public L_UserListAdapter(Context context, List<com.bitc.L_User> userList, Activity parentActivity){
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        View v = View.inflate(context, R.layout.l_user, null);
        //뷰에 다음 컴포넌트들을 연결시켜줌
        ...
        userPassword.setText("PW:"+userList.get(i).getUserPassword());
        userName.setText("Name:"+userList.get(i).getUserName());
        ...
        deleteButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                L_DeleteRequest deleteRequest = new L_DeleteRequest(userID.getText().toString(), responseListener);
