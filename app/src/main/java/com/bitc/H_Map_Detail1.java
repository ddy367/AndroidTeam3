...
//                mContext = MyApp.ApplicationContext();
        ...
        protected void onPostExecute(String result) {
            Intent intent = new Intent(H_Map_Detail1.this, L_MemberListActivity.class); //parentActivity값이 널이라서 현재 에러가 나고 있습니다
            intent.putExtra("userList", result);//파싱한 값을 넘겨줌
            H_Map_Detail1.this.startActivity(intent);//ManagementActivity로 넘어감
        }
